...
/**
 * Default EPG SSO identity provider.
 */
public class DefaultEPGSSOIdentityProvider implements SSOIdentityProvider {

    private static final Logger log = LoggerFactory.getLogger(DefaultEPGSSOIdentityProvider.class);
